                                            ...
                                            [FB_REF authWithOAuthProvider:@"facebook" token:accessToken
                                                      withCompletionBlock:^(NSError *error, FAuthData *authData) {
                                                          if (error) {
                                                              ...
                                                              NSLog(@"Logged in with facebook! %@", authData);
                                                              ...
                                                              [[NSUserDefaults standardUserDefaults] setObject:@"facebook" forKey:SOCIAL_LOGIN_KEY];
...
- (IBAction)loginWithTwitter:(id)sender {
    ...
    [[Twitter sharedInstance] logInWithCompletion:^(TWTRSession *session, NSError *error) {
        ...
        if (session) {
            ...
            [[NSUserDefaults standardUserDefaults] setObject:[session userName] forKey:USER_NAME_KEY];
